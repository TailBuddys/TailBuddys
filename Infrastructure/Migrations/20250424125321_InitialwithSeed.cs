        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 21, new DateTime(1982, 4, 2, 12, 53, 21, 466, DateTimeKind.Utc).AddTicks(412), new DateTime(2025, 4, 24, 12, 53, 21, 465, DateTimeKind.Utc).AddTicks(9741), "regular@user.buddy", "regular", 0, null, false, "user", "AQAAAAIAAYagAAAAEDPYgloSooRfNJnLqbRCRe2KWaScEGE5MFPcCfwAx0zWUsOpoahEonD7usrdp1fqfQ==", null, new DateTime(2025, 4, 24, 12, 53, 21, 465, DateTimeKind.Utc).AddTicks(9741) },
                    { 22, new DateTime(1982, 4, 2, 12, 53, 21, 466, DateTimeKind.Utc).AddTicks(412), new DateTime(2025, 4, 24, 12, 53, 21, 465, DateTimeKind.Utc).AddTicks(9741), "admin@tail.buddy", "admin", 0, null, true, "user", "AQAAAAIAAYagAAAAEDPYgloSooRfNJnLqbRCRe2KWaScEGE5MFPcCfwAx0zWUsOpoahEonD7usrdp1fqfQ==", null, new DateTime(2025, 4, 24, 12, 53, 21, 465, DateTimeKind.Utc).AddTicks(9741) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, 2, "Kai", "Easy-going temperament, great with kids and other dogs, loves weekend hikes and swimming in shallow creeks.", 55, 2, false, new DateTime(2014, 4, 9), "Tel Aviv District, Israel", 34.8072165, 32.0929075, true, true, DateTime.UtcNow, DateTime.UtcNow },
                    ...
                    { 8, 4, "Bamba", "Shy at first but opens up with treats and patience, loves head scratches and walks in quiet areas.", 140, 0, false, new DateTime(2015, 4, 2), "Ramat David, Israel", 35.204036, 32.678991, true, true, DateTime.UtcNow, DateTime.UtcNow },
                    ...
                    { 12, 6, "Lichi", "Adventurous spirit, always ready to explore new parks, meet new friends, and chase flying leaves.", 21, 1, false, new DateTime(2022, 4, 8), "Eilat, Israel", 34.951925, 29.557669, true, true, DateTime.UtcNow, DateTime.UtcNow },
                    ...
                    { 16, 21, "Boost", "A senior soul with a calm presence, enjoys slow strolls and warm hugs from familiar hands.", 82, 2, false, new DateTime(2021, 4, 21), "Ramat Gan, Israel", 34.824785, 32.068424, true, false, DateTime.UtcNow, DateTime.UtcNow },
                    ...
                    { 22, 12, "Amy", "Eager to please, easy to train, and always carries a toy around like it’s treasure.", 116, 0, true, new DateTime(2018, 4, 11), "Petah Tikva, Israel", 34.887762, 32.084041, true, true, DateTime.UtcNow, DateTime.UtcNow },
                    ...
                    { 28, 18, "Luc", "Very expressive, tilts head in curiosity to every word and barks to join the conversation", 140, 1, false, new DateTime(2025, 2, 3), "Bet Shemesh, Israel", 34.9866855, 31.7496628, true, true, DateTime.UtcNow, DateTime.UtcNow },
